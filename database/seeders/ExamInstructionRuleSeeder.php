    ...
    public function run(): void
    {
        ...
        $rules = [
            ...
            [
                ...
                'description' => 'Leaving the exam tab or minimizing the window triggers a warning. Repeated violations beyond the exam’s configured warning limit auto-submit the attempt.',
                'category' => 'monitoring',
                'icon' => 'tabs',
                'is_default' => true,
                'is_required' => false,
            ...
            [
                ...
                'description' => 'When enabled, common keyboard shortcuts (except exam navigation and answer typing) are blocked. OS-level switches like Alt+Tab may still work on some systems; pair with tab-switch detection and fullscreen for stronger coverage.',
                'category' => 'integrity',
                'icon' => 'keyboard',
                'is_default' => false,
                'is_required' => false,
