...
const SIDEBAR_KEY = 'ems.sidebarCollapsed';
...
function initSidebar() {
    ...
    const setCollapsed = (collapsed) => {
        ...
        document.querySelectorAll('[data-sidebar-label], [data-sidebar-avatar-details]').forEach((element) => {
...
function confirmFormMarkup(action, message) {
    ...
    return `<form method="POST" action="${action}" class="inline" data-confirm="${escapeHtml(message)}">
...
function wireConfirmForms(scope = document) {
