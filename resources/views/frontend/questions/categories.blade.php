...
@section('content')
    <div class="et-listing et-listing--stack" data-listing data-endpoint="{{ route('frontend.questions.categories') }}">
            ...
            <div class="et-container">
                ...
                <div class="et-page-hero__row">
                    ...
                    <div class="et-filter-toolbar">
                        <button type="button" class="et-btn et-btn--soft et-filter-trigger" data-filter-open aria-haspopup="dialog" aria-controls="et-qcat-filter-modal">
        ...
        <div class="et-container et-section">
            <div class="et-filter-modal" id="et-qcat-filter-modal" data-filter-modal hidden>
                <div class="et-filter-modal__backdrop" data-filter-close tabindex="-1"></div>
                <div class="et-filter-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="et-qcat-filter-title">
                    <div class="et-filter-modal__head">
                        <h2 id="et-qcat-filter-title">Filter categories</h2>
                    ...
                    <form class="et-filters et-filters--modal" method="get" action="{{ route('frontend.questions.categories') }}" data-load-more-filters data-default-sort="name">
                        ...
                        <label class="et-field">
                            ...
                            <span class="et-field__control">
                                ...
                                <select name="sort" aria-label="Sort">
                                    ...
                                    <option value="popular" @selected(request('sort') === 'popular')>Most questions</option>
                                </select>
                            </span>
                        </label>
            ...
            <div class="et-listing__main" data-listing-main>
                ...
                <div class="et-listing__empty" data-listing-empty @if(($categories ?? collect())->isNotEmpty()) hidden @endif>
                    @include('frontend.partials.empty-state', [
                        ...
                        'actionUrl' => route('frontend.questions.categories'),
                        'actionLabel' => 'Reset filters',
                    ])
                </div>

                <div class="et-grid et-grid--3" data-load-more-list @if(($categories ?? collect())->isEmpty()) hidden @endif>
