@php
    $shareUrl = $shareUrl ?? urlencode(url()->current());
    $shareText = $shareText ?? urlencode((string) ($shareTitle ?? ''));
    $shareRawUrl = $shareRawUrl ?? url()->current();
    $shareLabel = $shareLabel ?? 'Share';
@endphp
<div class="et-article__share" aria-label="{{ $shareLabel }}">
    <span class="et-article__share-label">{{ $shareLabel }}</span>
    <div class="et-article__share-actions">
        <a class="et-article__share-btn et-article__share-btn--whatsapp"
        ...
        <a class="et-article__share-btn et-article__share-btn--linkedin"
        ...
        <a class="et-article__share-btn et-article__share-btn--instagram"
           href="https://www.instagram.com/"
           target="_blank"
           rel="noopener noreferrer"
           title="Copy link and open Instagram"
           data-share-copy="{{ $shareRawUrl }}">
        ...
        <a class="et-article__share-btn et-article__share-btn--x"
        ...
        <button type="button"
                class="et-article__share-btn et-article__share-btn--copy"
                title="Copy link"
                data-share-copy-btn="{{ $shareRawUrl }}">
            <span class="et-visually-hidden">Copy link</span>
