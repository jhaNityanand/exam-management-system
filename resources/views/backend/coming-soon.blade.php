...
@section('title', $moduleTitle ?? 'Coming Soon')
@section('page-title', $moduleTitle ?? 'Work in Progress')
...
@section('breadcrumbs')
    ...
    <li>
        <div class="flex items-center">
            ...
            <span class="text-slate-800 dark:text-slate-200">{{ $moduleTitle ?? 'Coming Soon' }}</span>
        </div>
    </li>
@endsection
...
<div class="flex flex-col items-center justify-center py-20 px-4 text-center">
    ...
    <h2 class="mb-2 text-2xl font-bold text-slate-900 dark:text-white md:text-3xl">{{ $moduleTitle ?? 'Coming Soon' }}</h2>
    <p class="mb-8 max-w-lg text-slate-500 dark:text-slate-400">
        {{ $moduleMessage ?? "We're still working on this module. Check back later to see the new features and improvements." }}
    </p>
