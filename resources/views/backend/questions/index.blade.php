...
@section('header-actions')
    @orgCan('question.create')
        <a href="{{ route('admin.questions.create') }}" class="panel-button-primary">New question</a>
    @endorgCan
@endsection
...
@section('content')
    @php
        $endpoint = route('admin.internal-api.questions-table');
        $baseUrl = rtrim(route('admin.questions.index'), '/');
    @endphp
