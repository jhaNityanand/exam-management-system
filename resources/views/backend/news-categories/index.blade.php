...
@section('page-title', 'News Category List')
...
<div class="space-y-6">
    <section class="panel-card overflow-hidden">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                            Browse, search, and manage the parent-child news category structure.
                        </p>
                    </div>
        ...
        @include('backend.partials.category-bulk-bar', [
            'bulkDeleteRoute' => route('admin.news.categories.bulk-destroy'),
            'bulkRestoreRoute' => route('admin.news.categories.bulk-restore'),
            'bulkStatusRoute' => route('admin.news.categories.bulk-status'),
        ])
...
@push('scripts')
    ...
    <script>
        window.categoryTreeConfig = {
            indexUrl: @json(route('admin.news.categories.index')),
            detailsBaseUrl: @json(url('/admin/news/categories')),
            linkedResourceLabel: 'news',
            restoreBaseUrl: @json(url('/admin/news/categories')),
        };
    </script>
