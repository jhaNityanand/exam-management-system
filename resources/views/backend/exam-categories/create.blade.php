...
@section('title', 'Create Exam Categories')
@section('page-title', 'Create Exam Categories')
...
@section('breadcrumbs')
    <x-breadcrumb :items="[
            ...
            ['label' => 'Categories', 'url' => route('admin.exams.categories.index')],
            ['label' => 'Create'],
        ]" />
@endsection
...
@section('content')
    <div class="w-full space-y-6">
        ...
        <x-page-card class="category-builder-card overflow-hidden">
            <form id="category-tree-form" action="{{ route('admin.exams.categories.store') }}" method="POST"
                ...
                <div class="category-builder__header">
                    <div>
                        <h1 class="category-builder__title">Create Exam Category Hierarchy</h1>
                        ...
                        <div class="qcat-seo-container">
                            ...
                            <div class="qcat-seo-row qcat-seo-row--two-cols">
                                ...
                                <div class="qcat-meta-field col-lg-6">
                                    ...
                                    <input type="text" id="meta-keywords" name="meta_keywords" value="{{ old('meta_keywords', $seoItem?->meta_keywords ?? '') }}" placeholder="e.g. university admission, math exams" class="panel-input qcat-meta-input">
                ...
                <div class="category-builder__footer">
                    <a href="{{ route('admin.exams.categories.index') }}" class="panel-button-secondary">
                        Back
                    </a>
...
@push('scripts')
    ...
    <script src="{{ asset('js/backend/exam-category-form.js') }}"></script>
