...
@section('content')
    <div class="w-full space-y-6">
        ...
        <x-page-card class="category-builder-card overflow-hidden">
            <form id="category-tree-form" action="{{ route('admin.blogs.categories.update', $category) }}" method="POST"
                ...
                <div class="category-builder__header">
                    <div>
                        <h1 class="category-builder__title">Edit Blog Category Hierarchy</h1>
