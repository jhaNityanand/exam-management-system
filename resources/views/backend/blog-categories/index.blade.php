...
@section('page-title', 'Blog Category List')
...
<div class="space-y-6">
    <section class="panel-card overflow-hidden">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h2 class="text-xl font-semibold tracking-tight text-slate-950 dark:text-white">
                            Blog Category Explorer
                        </h2>
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                            Browse, search, and manage the parent-child blog category structure.
                        </p>
                    </div>
                ...
                <form id="filter-form" onsubmit="event.preventDefault();" class="list-toolbar !mt-0">
                    ...
                    <div class="list-toolbar__controls">
                        <x-list-view-tabs aria-label="Blog category visibility" />
                        {{-- Expand All --}}
        ...
        @include('backend.partials.category-bulk-bar', [
            'bulkDeleteRoute' => route('admin.blogs.categories.bulk-destroy'),
            'bulkRestoreRoute' => route('admin.blogs.categories.bulk-restore'),
            'bulkStatusRoute' => route('admin.blogs.categories.bulk-status'),
        ])
...
@push('scripts')
    ...
    <script>
        window.categoryTreeConfig = {
            indexUrl: @json(route('admin.blogs.categories.index')),
            detailsBaseUrl: @json(url('/admin/blogs/categories')),
            linkedResourceLabel: 'blogs',
            restoreBaseUrl: @json(url('/admin/blogs/categories')),
        };
    </script>
