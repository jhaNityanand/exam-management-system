...
@section('title', 'Create Blog Categories')
@section('page-title', 'Create Blog Categories')
...
@section('breadcrumbs')
    <x-breadcrumb :items="[
            ...
            ['label' => 'Categories', 'url' => route('admin.blogs.categories.index')],
            ['label' => 'Create'],
        ]" />
@endsection
...
@section('content')
    <div class="w-full space-y-6">
        ...
        <x-page-card class="category-builder-card overflow-hidden">
            <form id="category-tree-form" action="{{ route('admin.blogs.categories.store') }}" method="POST"
                ...
                <div class="category-builder__header">
                    <div>
                        <h1 class="category-builder__title">Create Blog Category Hierarchy</h1>
                        ...
                        <div class="qcat-seo-container">
                            ...
                            <div class="qcat-seo-row qcat-seo-row--two-cols">
                                ...
                                <div class="qcat-meta-field col-lg-6">
                                    ...
                                    <input type="text" id="meta-keywords" name="meta_keywords" value="{{ old('meta_keywords', $seoItem?->meta_keywords ?? '') }}" placeholder="e.g. university admission, blog posts" class="panel-input qcat-meta-input">
                ...
                <div class="category-builder__footer">
                    <a href="{{ route('admin.blogs.categories.index') }}" class="panel-button-secondary">
                        Back
                    </a>
...
@push('scripts')
    ...
    <script src="{{ asset('js/backend/blog-category-form.js') }}"></script>
