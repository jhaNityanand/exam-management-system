            ...
            <div class="list-toolbar">
                ...
                <div class="list-toolbar__controls">
                    <div class="list-toolbar__per-page">
                        <select id="blogs-per-page" class="panel-input per-page-select w-full text-sm" data-disable-search data-placeholder="Select page size">
        ...
        <div id="blogs-bulk-bar" class="list-bulk-bar blog-bulk-bar" hidden>
            <div class="list-bulk-bar__inner">
                ...
                <div class="list-bulk-bar__actions">
                    ...
                    <div id="blogs-bulk-actions-bin" class="list-bulk-bar__group" hidden>
