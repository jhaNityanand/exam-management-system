/**
 * exam-category-list.js
 *
 * Handles the interactive behavior of the Exam Category index (tree list) page:
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const openDetailsModal = (categoryId) => {
        ...
        fetch(`/admin/exams/categories/${categoryId}`, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
        ...
        Swal.fire({
            ...
            html: `
                <div class="swal-cat-body">
                    ...
                    <p class="swal-cat-warning">This action is <strong>irreversible</strong>. All sub-categories and exams linked to this entry will also be affected.</p>
                </div>
            `,
