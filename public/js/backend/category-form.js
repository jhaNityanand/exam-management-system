/**
 * Shared category form logic for Exam / Question / Blog category create & edit.
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    const validateCanonical = (fieldId) => {
    ...
    const form = document.getElementById('qcat-edit-form')
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (!validateCanonical(canonicalId)) {
            valid = false;
        }
