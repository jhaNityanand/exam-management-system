document.addEventListener('DOMContentLoaded', () => {
    ...
    const statusSelect = document.getElementById('exam-list-status');
    const modeSelect = document.getElementById('exam-list-mode');
    const sortSelect = document.getElementById('exam-list-sort');

    if (!tableBody || !paginationEl || !statGridEl) {
        return;
    }
    ...
    const dummyExams = [
        {
            ...
            description: 'Covers frontend architecture, backend APIs, performance profiling, and deployment readiness for production teams.',
            status: 'published',
            exam_mode: 'proctored',
            duration: 120,
            pass_percentage: 70,
            ...
            scheduled_start: '2026-05-03T09:00:00',
            scheduled_end: '2026-05-03T14:00:00',
            shuffle_questions: true,
            shuffle_options: true,
            updated_at: '2026-04-24T10:00:00',
            owner_name: 'Ava Martin',
        },
        {
            id: 2,
            title: 'Physics Foundation Benchmark',
            description: 'Assesses classical mechanics, optics, and basic electromagnetic reasoning for entry-level candidates.',
            status: 'draft',
            exam_mode: 'standard',
            duration: 75,
            pass_percentage: 55,
            ...
            shuffle_options: true,
            updated_at: '2026-04-23T13:32:00',
            owner_name: 'Noah Patel',
        },
        {
            id: 3,
            title: 'Biology Practice Sprint',
            description: 'Short-format assessment for quick revision on cells, genetics, and ecology fundamentals.',
            status: 'active',
            exam_mode: 'practice',
            duration: 40,
            pass_percentage: 50,
            ...
            scheduled_start: '2026-04-28T08:30:00',
            scheduled_end: '2026-06-30T23:59:00',
            shuffle_questions: true,
            shuffle_options: false,
            updated_at: '2026-04-22T09:18:00',
            owner_name: 'Mia Johnson',
        },
        {
            id: 4,
            title: 'Aptitude Screening - Batch A',
            description: 'Timed aptitude exam for shortlisting candidates before technical interview rounds.',
            status: 'published',
            exam_mode: 'standard',
            duration: 60,
            pass_percentage: 60,
            max_attempts: 1,
            question_count: 36,
            category_name: 'General Aptitude',
            scheduled_start: '2026-05-01T10:00:00',
            scheduled_end: '2026-05-15T18:00:00',
            shuffle_questions: true,
            shuffle_options: true,
            updated_at: '2026-04-21T16:05:00',
            owner_name: 'Liam Walker',
        },
        {
            id: 5,
            title: 'Data Structures Advanced Evaluation',
            description: 'Evaluates algorithmic thinking, time complexity optimization, and data structure selection.',
            status: 'inactive',
            exam_mode: 'proctored',
            duration: 90,
            pass_percentage: 68,
            ...
            shuffle_questions: false,
            shuffle_options: false,
            updated_at: '2026-04-19T11:20:00',
            owner_name: 'Ethan Ramirez',
        },
        {
            id: 6,
            title: 'Mathematics Placement Test',
            description: 'Used for academic stream placement with emphasis on algebra, geometry, and statistics.',
            status: 'published',
            exam_mode: 'standard',
            duration: 100,
            pass_percentage: 65,
            ...
            scheduled_start: '2026-05-10T07:30:00',
            scheduled_end: '2026-05-10T18:30:00',
            shuffle_questions: true,
            shuffle_options: false,
            updated_at: '2026-04-18T08:15:00',
            owner_name: 'Sophia Allen',
        },
        {
            id: 7,
            title: 'API Design and Security Audit',
            description: 'Scenario-based exam focusing on REST standards, auth flows, and secure API lifecycle management.',
            status: 'draft',
            exam_mode: 'proctored',
            duration: 85,
            pass_percentage: 72,
            ...
            shuffle_questions: true,
            shuffle_options: true,
            updated_at: '2026-04-17T14:48:00',
            owner_name: 'Olivia Cruz',
        },
        {
            id: 8,
            title: 'Logical Reasoning Warm-Up',
            description: 'Low-stakes practice exam for fresh candidates preparing for reasoning and puzzle rounds.',
            status: 'active',
            exam_mode: 'practice',
            duration: 30,
            pass_percentage: 45,
            ...
            scheduled_end: '2026-12-31T23:00:00',
            shuffle_questions: true,
            shuffle_options: true,
            updated_at: '2026-04-16T12:11:00',
            owner_name: 'James Chen',
        },
        {
            id: 9,
            title: 'Network Administration Gate',
            description: 'Intermediate level objective test on routing, switching, and incident response controls.',
            status: 'suspended',
            exam_mode: 'standard',
            duration: 70,
            pass_percentage: 58,
            ...
            scheduled_start: '2026-05-05T10:30:00',
            scheduled_end: '2026-05-05T16:30:00',
            shuffle_questions: false,
            shuffle_options: false,
            updated_at: '2026-04-15T15:24:00',
            owner_name: 'Isabella Reed',
        },
        {
            id: 10,
            title: 'Commerce Fundamentals Checkpoint',
            description: 'Assesses accounting and economics basics for business-oriented entry roles.',
            status: 'published',
            exam_mode: 'standard',
            duration: 55,
            pass_percentage: 52,
            ...
            shuffle_questions: false,
            shuffle_options: true,
            updated_at: '2026-04-14T09:36:00',
            owner_name: 'Lucas Scott',
        },
        {
            id: 11,
            title: 'Frontend UI Architecture Drill',
            description: 'Hands-on and conceptual exam around component architecture, accessibility, and state management.',
            status: 'active',
            exam_mode: 'practice',
            duration: 65,
            pass_percentage: 60,
            ...
            scheduled_start: '2026-04-29T08:00:00',
            scheduled_end: '2026-06-01T22:00:00',
            shuffle_questions: true,
            shuffle_options: true,
            updated_at: '2026-04-13T10:12:00',
            owner_name: 'Emma Brooks',
        },
        {
            id: 12,
            title: 'Chemistry Competitive Mock',
            description: 'Mock exam with sectional timing and negative marking for competitive prep batches.',
            status: 'draft',
            exam_mode: 'standard',
            duration: 110,
            pass_percentage: 64,
            ...
            shuffle_questions: true,
            shuffle_options: true,
            updated_at: '2026-04-12T13:57:00',
            owner_name: 'William Diaz',
        },
    ];
    ...
    const sortRecords = (data, key, direction) => {
        const sorted = [...data];
    ...
    const updateStats = (data) => {
        ...
        const avgDuration = data.length
            ? Math.round(data.reduce((sum, item) => sum + item.duration, 0) / data.length)
            : 0;
        ...
        statGridEl.innerHTML = statCards.map((stat) => `
            <article class="exam-stat-card">
                <p class="exam-stat-title">${escapeHtml(stat.title)}</p>
                <p class="exam-stat-value">${escapeHtml(stat.value)}</p>
            </article>
        `).join('');
    };
    ...
    const renderRow = (row) => {
        ...
        const statusClass = statusClassMap[row.status] || 'exam-status-draft';
            ...
            <tr class="transition hover:bg-slate-50 dark:hover:bg-slate-900/30">
                <td class="px-6 py-4 align-top">
                    <div class="space-y-2">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="exam-status-badge ${statusClass}">${escapeHtml(row.status)}</span>
                        </div>
                ...
                <td class="px-6 py-4 align-top">
                    <div class="space-y-2 text-xs text-slate-600 dark:text-slate-300">
                        <p><span class="font-semibold text-slate-700 dark:text-slate-200">${escapeHtml(row.question_count)}</span> questions configured</p>
                        ...
                        <div class="flex flex-wrap gap-1.5">
                            ...
                            ${row.shuffle_options ? '<span class="exam-meta-chip">Shuffle Options</span>' : ''}
                        </div>
                    </div>
                </td>
    ...
    const renderPagination = (meta) => {
        if (meta.total <= state.perPage) {
            paginationEl.innerHTML = `
                <p class="text-sm text-slate-500 dark:text-slate-400">
                    Showing <span class="font-medium text-slate-700 dark:text-slate-200">${meta.total}</span> records
                </p>
            `;
            return;
        }
        ...
        paginationEl.innerHTML = `
            <p class="hidden text-sm text-slate-500 dark:text-slate-400 sm:block">
                ...
                of <span class="font-medium text-slate-700 dark:text-slate-200">${meta.total}</span> records
            </p>
            <div class="flex items-center gap-2">
    ...
    const applyFiltersAndSorting = () => {
        ...
        const filtered = records.filter((record) => {
            const matchesSearch = !query
                || normalize(record.title).includes(query)
                || normalize(record.category_name).includes(query)
                || normalize(record.owner_name).includes(query)
                || normalize(record.exam_mode).includes(query);
            const matchesStatus = !state.status || record.status === state.status;
            const matchesMode = !state.mode || record.exam_mode === state.mode;

            return matchesSearch && matchesStatus && matchesMode;
        });

        const [sortField, sortDirection = 'desc'] = state.sort.split(':');
    ...
    const render = () => {
        ...
        window.setTimeout(() => {
            ...
            const toIndex = fromIndex + state.perPage;
    ...
    sortSelect?.addEventListener('change', (event) => {
        state.sort = event.target.value || 'updated_at:desc';
        state.page = 1;
        render();
    });

    paginationEl.addEventListener('click', (event) => {
        const button = event.target.closest('.js-page-btn');
    ...
    tableBody.addEventListener('click', (event) => {
        const deleteButton = event.target.closest('.js-delete-exam');
        if (!deleteButton) {
            return;
        }
        ...
        if (window.Swal) {
            window.Swal.fire({
                ...
                text: 'Demo mode only: this updates the local list and does not touch the database.',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    window.Swal.fire({
                        icon: 'success',
                        title: 'Removed',
                        text: 'The demo exam row has been removed.',
                        timer: 1300,
        ...
        if (window.confirm('Remove this exam from the demo list?')) {
            proceed();
        }
    });
